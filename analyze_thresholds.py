...
table_df = pd.DataFrame(table_rows, columns=['Minimum samples per disease', 'Number of diseases', 'Total samples retained'])
...
table.scale(1.2, 1.5)
plt.title('Dataset Size vs Minimum Disease Sample Threshold', fontsize=13, pad=12)
plt.tight_layout()
plt.savefig('disease_threshold_table.jpeg', dpi=300, bbox_inches='tight')
plt.show()
